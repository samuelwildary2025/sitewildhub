      ...
      <div className="container-custom section-padding">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-bold">WildHub</span>
            </div>
            <p className="text-gray-300 mb-4">
              Transformamos ideias em experiências digitais excepcionais. 
              Desenvolvimento web moderno com foco em performance e usabilidade.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center space-x-2">
                ...
                <span className="text-gray-300">contato@wildhub.dev</span>
              </li>
              <li className="flex items-center space-x-2">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © {new Date().getFullYear()} WildHub. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
