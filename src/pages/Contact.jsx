          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <div className="bg-slate-900/30 backdrop-blur-sm border border-slate-800/50 rounded-xl p-4 text-center">
                ...
                <p className="text-body text-blue-400 hover:text-blue-300 transition-colors cursor-pointer" onClick={() => toast({ description: 'Funcionalidade de chamada não implementada.' })}>+55 (11) 98765-4321</p>
              </div>
